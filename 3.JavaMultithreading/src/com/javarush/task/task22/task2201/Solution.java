...
public class Solution {
    ...
    public synchronized String getPartOfString(String string, String threadName) {
        if (string != null && string.contains("\t")) {
            ...
            if (threadName.equals(FIRST_THREAD_NAME)) {
                throw new StringForFirstThreadTooShortException(new StringIndexOutOfBoundsException());
            }
            if (threadName.equals(SECOND_THREAD_NAME)) {
                throw new StringForSecondThreadTooShortException(new StringIndexOutOfBoundsException());
            }
            else throw new RuntimeException();
        }
    }
