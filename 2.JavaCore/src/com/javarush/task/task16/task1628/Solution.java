...
/*          ПОНЯТЬ
        ЧТО
                ...
                J<ZDS:LDLS:DKL:KDSL:DKSL:KDSSLK:DKS:LDKSL:DKL:KDc,m.amasfmklewafj:SLFL:JSLKJFLKSJFKLJSFLKJALKASJFKLAMCSKLAIFH
                sfdssssssssd
                dfsds
            ...
            while (!isInterrupted()) {
                try {
                    if (reader.ready()) {
                        ...
                        readStringCount.set(readStringCount.incrementAndGet());
                    }
                }
                catch (IOException e) {
